...
Quick start:
- `python -m pip install PyQt6 PyQt6-WebEngine beautifulsoup4 mysql-connector-python`
...
- MySQL can be configured in the app settings or with `ARTBROWSER_MYSQL_HOST`, `ARTBROWSER_MYSQL_PORT`, `ARTBROWSER_MYSQL_DATABASE`, `ARTBROWSER_MYSQL_USER`, and `ARTBROWSER_MYSQL_PASSWORD`.
